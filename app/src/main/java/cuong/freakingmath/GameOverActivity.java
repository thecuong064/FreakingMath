...
public class GameOverActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //custom font
        Typeface t = Typeface.createFromAsset(getAssets(),"gohan.ttf");
        ...
        resumeBtn.setTypeface(t);
            resumeBtn.setTextColor(getResources().getColor(R.color.textColor));
        exitBtn.setTypeface(t);
            exitBtn.setTextColor(getResources().getColor(R.color.textColor));
        ...
        //set Text
        title.setText("FREAKING MATH");
        over.setText("GAME OVER");
        cScore.setText("SCORE");
        resumeBtn.setText("PLAY");
